...
module.exports = {
  ...
  theme: {
    ...
    extend: {
      ...
      fontFamily: {
        // 默认中英文字体
        normal: `-apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, "Helvetica Neue", Arial, "Noto Sans", sans-serif, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", "Noto Color Emoji"`,
        // 用于数字显示的 D-DIN 字体
        din: `"D-DIN", -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, "Helvetica Neue", Arial, "Noto Sans", sans-serif, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", "Noto Color Emoji"`
      },
      gridTemplateColumns: {
